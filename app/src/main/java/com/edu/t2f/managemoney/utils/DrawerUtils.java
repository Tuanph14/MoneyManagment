package com.edu.t2f.managemoney.utils;
...
public final class DrawerUtils {
    ...
    public static List<IDrawerItem> getDrawerItems() {
        ...
        PrimaryDrawerItem homeItem = new PrimaryDrawerItem().withName(R.string.drawer_item_home)
                .withIcon(CommunityMaterial.Icon.cmd_home).withIdentifier(ITEM_HOME);
        ...
        for(Category category : OpenPocket.get().getCategoryManager().getCategoryList()) {
            PrimaryDrawerItem catItem = new PrimaryDrawerItem().withName(category.getCategoryName())
                    .withDescription(category.getCategoryDescription()).withIcon(IconParser
                            .getIcon(category.getCategoryIcon()));
        ...
        PrimaryDrawerItem aboutItem = new PrimaryDrawerItem().withName(R.string.drawer_item_about)
                .withIcon(CommunityMaterial.Icon.cmd_information_outline);
        PrimaryDrawerItem prefItem = new PrimaryDrawerItem().withName(R.string.drawer_item_pref).
