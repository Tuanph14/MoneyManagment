package com.edu.t2f.managemoney;
...
import com.edu.t2f.managemoney.adapters.ViewPagerAdapter;
import com.edu.t2f.managemoney.utils.DrawerUtils;
import com.edu.t2f.managemoney.views.CoordinatorBalanceView;
import com.edu.t2f.managemoney.views.CustomAppBarLayout;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setImageDrawable(new IconicsDrawable(this)
                .icon(CommunityMaterial.Icon.cmd_plus).color(Color.WHITE).sizeDp(18));
    ...
    private void buildNavigationDrawer(Bundle savedInstance) {
        ...
        ProfileDrawerItem activeProfileItem = new ProfileDrawerItem().withName(activeProfile.getProfileName())
                .withEmail(activeProfile.getProfileDescription());
